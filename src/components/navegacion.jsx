    ...
    return (
        <nav className="bg-white rounded-lg m-2 md:flex md:items-center md:justify-between p-4 font-medium text-black shadow-[0px_0px_10px_3px_rgba(0,0,0,0.15)]">
            <div className="flex items-center justify-center  md:flex md:items-center md:justify-start">
                ...
                <h1 className="text-black text-xl ml-4"><span className="text-orange-600">Sky</span><span className="text-blue-500">Check</span></h1>  
            </div>

            <ul className="flex items-center justify-center gap-8 mt-4 md:mt-0 w-full">
                <li className="hover:underline me-4 md:me-6 text-orange-600 ">
                    <Link to="/">Inicio</Link>
                </li>
            ...
            <form className="w-full max-w-sm mt-4 md:mt-0">
                ...
                <div className="relative">
                    <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                        <svg className="w-4 h-4 text-orange-600 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                    ...
                    <button type="submit" className="text-white absolute right-2.5 bottom-2.5 bg-orange-600 hover:bg-orange-300 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm px-4 py-2">Buscar</button>
                </div>
            </form>
        </nav>
    )
