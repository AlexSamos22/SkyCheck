        ...
        <nav className="bg-white rounded-lg m-2 md:flex md:items-center md:justify-between p-4 font-medium text-black shadow-[0px_0px_10px_3px_rgba(0,0,0,0.15)]">
            ...
            <form className="w-full max-w-sm mt-4 md:mt-0">
                ...
                <div className="relative">
                    ...
                    <input type="search" id="default-search" className="block w-full p-4 pl-10 text-sm text-gray-900 border-2 border-blue-500 rounded-lg bg-white focus:ring-blue-500 focus:border-blue-500 outline-none " placeholder="Buscar..." required />
